...
/**
 * Nom de la class: PresentationController()
 *
...
namespace App\Controllers\Simple_controllers\Guide;

class PresentationController extends \Core\System\ControllersProviderSystem
{
    /**
    ...
    {
        $this->setPageView('presentation.twig');
        $this->setPageInfos(array(
            'page_title' => 'Présentation du fralework'
        ));
    }
